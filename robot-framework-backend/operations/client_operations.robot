...
#Endpoints
${get_client_counter_endpoint}     /hotel-rest/webresources/client/count
${get_all_clients_endpoint}        /hotel-rest/webresources/client
#includ the id as a parameter when we do the request
...
Create Json data For a Client
    ...
    ${email}=	                   Catenate   SEPARATOR=     ${name}@hotmail.com"
